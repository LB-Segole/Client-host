import { Plus, Settings, Trash2, Mic, MicOff, Loader2 } from 'lucide-react';
...
export const Agents = () => {
  ...
  // Add Urdu to the language options in the modal select
  // (No code needed here, see below for select options update)
  useEffect(() => {
