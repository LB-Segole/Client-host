  ...
  return (
    <Card className="max-w-md mx-auto p-6">
      ...
      <div className="mt-6 text-center text-sm text-gray-600">
        ...
        <button
          type="button"
          className="font-medium text-blue-600 hover:text-blue-500 bg-transparent border-none p-0 underline cursor-pointer"
          onClick={() => {
            // TODO: handle sign up action (e.g., navigate to sign up page)
          }}
        >
          Sign up
        </button>
